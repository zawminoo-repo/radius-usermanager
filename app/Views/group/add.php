...
<div id="main" style="margin-left:200px">
	...
	<div class="w3-container w3-display-container">
		...
		<h3 class="h3" style="text-align:center;padding:20px"><strong>Add Group</strong></h3>
		
		<?php $validation = session()->getFlashdata('validation'); ?>
		<form class="w3-container" action="<?= base_url(route_to('group_add')); ?>" method="post">
			<?= csrf_field(); ?>
			<p>      
			<label><b>Group Name:</b></label> <?= isset($validation['group_name']) ? '<span class="w3-text-red">Required Field.</span>' : ''; ?>
			<input class="w3-input w3-border" name="group_name" type="text" style="margin-top:5px" value="<?= old('group_name'); ?>">
			</p>
			<p>      
			<label><b>Group Description:</b></label>
			<input class="w3-input w3-border" name="group_descript" type="text" style="margin-top:5px" value="<?= old('group_descript'); ?>">
			</p>
