...
<div id="main" style="margin-left:200px">
	...
	<div class="w3-container w3-display-container">
		...
		<h3 class="h3" style="text-align:center;padding-top:20px"><strong>Group List</strong></h3>
		...
		<div class="w3-row-padding">
			<div class="w3-col m2">
				<a href="<?= base_url(route_to('group_add')); ?>" class="w3-btn w3-green"><i class="fa fa-plus"></i></a>
			</div>
		</div>
			...
			<table class="w3-table-all w3-hoverable">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $group->group_descript; ?></td>
						<td>
							<a href="<?= base_url(route_to('group_show', $group->id)); ?>"><i class="fa fa-eye" style="font-size:20px;color:green"></i></a> 
							<a href="<?= base_url(route_to('group_edit', $group->id)); ?>"><i class="fa fa-edit" style="font-size:20px;color:blue"></i></a> 
							<a href="<?= base_url(route_to('group_delete')); ?>?id=<?= $group->id; ?>"  onClick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash" style="font-size:20px;color:red"></i></a>
						</td>
					</tr>
					<?php endforeach; ?>
				<tbody>
