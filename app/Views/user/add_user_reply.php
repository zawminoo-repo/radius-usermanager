...
<div id="main" style="margin-left:200px">
	...
	<div class="w3-container w3-display-container">
		...
		<h3 class="h3" style="text-align:center;padding:20px"><strong>Add User Reply</strong></h3>
		
		<?php $validation = session()->getFlashdata('validation'); ?>
		<form class="w3-container" action="<?= base_url(route_to('user_reply_add', $user->id)); ?>" method="post">
			<?= csrf_field(); ?>
			<p>      
